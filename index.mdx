...
<iframe src="https://www.youtube.com/embed/5Atf-WXemU8" title="YouTube video player" frameborder="0" className="w-full aspect-video rounded-xl" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen />

<Card title="Hello" icon="sparkles">
  nxbwjhsvdxwq cxwgfcxhqw xAWVCAUYWQGdx qwcmhwguCGWE KHSACIWQBC CWQUYGCXUA SCNW CUYWGCUQWIBCASN CWHJGCUWQGCWQ
</Card>
...
<Columns cols={2}>
  <Column>
    <Card title="hswvdhjw " icon="sparkles">
      cjbwjcgxuwcxuew
    </Card>
  </Column>
  <Column>
    <Card title="mswj" icon="sparkles">
      dxwhjdcjwe
    </Card>
  </Column>
</Columns>